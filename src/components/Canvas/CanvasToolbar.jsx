  ...
  const renderUndoRedoCrop = (className = '') => (
    <div className={`flex items-center gap-2 shrink-0 ${className}`}>
      <button
        ...
        className="p-2 rounded-md border border-neutral-700 text-neutral-300 disabled:opacity-40 hover:bg-neutral-800"
        title="Undo"
      >
        <Undo size={18} />
      </button>
      ...
      <button
        type="button"
        onClick={onOpenCrop}
        className="p-2 rounded-md border border-orange-600 text-orange-400 hover:bg-orange-600/10"
        title="Crop"
      >
        <Crop size={18} />
      </button>
    ...
    <div className="flex flex-col gap-2 px-3 py-2 bg-neutral-950">
      ...
      <div className="flex items-center gap-2 w-full overflow-x-auto hide-scrollbar">
        <button
          ...
          className="px-4 py-2 rounded-md bg-orange-600 text-sm whitespace-nowrap font-medium flex items-center gap-2 hover:bg-orange-700 shrink-0"
        >
          <Type size={18} />
          Add Text
        </button>
        <button
          ...
          className="p-2 rounded-md border border-neutral-700 text-neutral-300 hover:bg-neutral-800 shrink-0"
          title="Delete Text"
        >
          <Trash2 size={18} />
        </button>
        ...
        <button
          ...
          className="flex flex-row items-center p-2 rounded-md border border-neutral-700 text-neutral-300 hover:bg-neutral-800 ml-auto shrink-0"
          title="Clear Image"
        >
          <Eraser size={18} />
